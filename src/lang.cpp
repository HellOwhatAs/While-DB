...
void free_cmd(struct cmd* c) {
    ...
    case T_ASGN:
        //printf("ASGN(");
        free_expr(c->d.ASGN.left);
        //printf(",");
        free_expr(c->d.ASGN.right);
        //printf(")");
        break;
    case T_SEQ:
        //printf("SEQ(");
        free_cmd(c->d.SEQ.left);
        //printf(",");
        free_cmd(c->d.SEQ.right);
        //printf(")");
        break;
    case T_IF:
        //printf("IF(");
        free_expr(c->d.IF.cond);
        //printf(",");
        free_cmd(c->d.IF.left);
        //printf(",");
        free_cmd(c->d.IF.right);
        //printf(")");
        break;
    case T_WHILE:
        //printf("WHILE(");
        free_expr(c->d.WHILE.cond);
        //printf(",");
        free_cmd(c->d.WHILE.body);
        //printf(")");
        break;
    case T_WI:
        //printf("WRITE_INT(");
        free_expr(c->d.WI.arg);
        //printf(")");
        break;
    case T_WC:
        //printf("WRITE_CHAR(");
        free_expr(c->d.WC.arg);
        //printf(")");
        break;
    }
    free(c);
